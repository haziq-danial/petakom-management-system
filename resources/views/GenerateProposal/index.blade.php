                    ...
                    @foreach($proposals as $proposal)
                        <tr>
                            ...
                            <td class="text-center">
                                <i class="fas fa-info-circle" style="cursor: pointer;" onclick="statusReport({{ $proposal }})"></i>
                            </td>
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <a class="dropdown-item" href="{{ route('manage-proposal.edit', $proposal->ProposalID) }}">Edit Proposal</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
