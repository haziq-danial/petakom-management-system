...
@section('content')
    ...
    <section class="content">
        <div class="card card-primary card-outline">
            ...
            <!-- /.card-header -->
            <form action="{{ route('manage-proposal.update', $proposal->ProposalID) }}" method="post">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <input class="form-control" name="title" value="{{ $proposal->title }}" placeholder="Report Title">
                    </div>
                    <div class="form-group">
